...
#define MSIMXVPUH264_DEC_DESCRIPTION "Freescale iMX VPU Coder/Decoder"
...
static void msimxvpuh264_enc_init(MSFilter *f) {
	MSIMXVPUH264Encoder *e = new MSIMXVPUH264Encoder(f);
	f->data = e;
}

static void msimxvpuh264_enc_preprocess(MSFilter *f) {
	MSIMXVPUH264Encoder *e = static_cast<MSIMXVPUH264Encoder *>(f->data);
	e->initialize();
}
...
#define MSIMXVPUH264_ENC_DESCRIPTION "Freescale iMX VPU Coder/Decoder"
#define MSIMXVPUH264_ENC_CATEGORY    MS_FILTER_ENCODER
#define MSIMXVPUH264_ENC_ENC_FMT     "H264"
...
MSFilterDesc msimxvpuh264_enc_desc = {
	...
	.enc_fmt = MSIMXVPUH264_ENC_ENC_FMT,
